...
| [[memtrace-public]] | partial-borrow / monitor | Closed engine + proprietary EULA (no competing-product; legal review) + mandatory vendor heartbeat. Additive: symbol-level bi-temporal graph, temporal scoring, cochange, API topology. Recommended: clean-room borrow the bi-temporal schema into AOS scanner+Neo4j (Option B). Not greenlit | Repository scanner, Architecture Spine Graph | evaluated | [[../../../docs/repo-research/memtrace-public\|report]] |
