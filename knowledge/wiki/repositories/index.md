...
| [[obsidian-skills]] | partial-borrow | MIT, Obsidian CEO, pure SKILL.md. ADOPT json-canvas (portable visual output the Spine Graph lacks) + obsidian-markdown. REJECT cli/bases (need running Obsidian app; headless-incompatible) + defuddle (Firecrawl dup). Not greenlit | Architecture Studio, Knowledge Vault | evaluated | [[../../../docs/repo-research/obsidian-skills\|report]] |
