...
export type Job = {
  ...
  project_id: string | null;
  repository_id: string | null;
  // AOS-NODE-EXECUTION-001: routing decision fields for the Control Tower audit.
...
export type Connector = {
  ...
  enabled: boolean;
  configured: boolean;
  // AOS-CONNECTOR-RUNTIME-001: decomposed health — credential present vs actually reachable.
