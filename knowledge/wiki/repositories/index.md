...
| [[T3MP3ST]] | partial-borrow (patterns) / monitor | AGPL — no code. Re-implement clean: risk-tiered tool catalog, human-veto approval gate, decomposition orchestrator, egress scope containment. Optional AGPL-isolated recon service for EES. Not greenlit | Engineering Evaluation Standard | evaluated | [[../../../docs/repo-research/T3MP3ST\|report]] |
