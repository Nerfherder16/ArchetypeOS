...
The reference emphasizes improving CLAUDE.md when repeated mistakes happen.
...
The most important transferable idea is not any single command. It is the loop:
