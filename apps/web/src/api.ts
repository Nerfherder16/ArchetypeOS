...
export type Job = {
  ...
  project_id: string | null;
  repository_id: string | null;
  // AOS-NODE-EXECUTION-001: routing decision fields, surfaced for the Control Tower audit.
  sensitivity: string;
...
export type Connector = {
  ...
  enabled: boolean;
  configured: boolean;
  // AOS-CONNECTOR-RUNTIME-001: decomposed status — credential stored vs reachable.
