...
from .routes import architecture, artifacts, council, decisions, digests, jobs, knowledge, projects, repositories, scans, schedules, transfer
...
for _module in (projects, repositories, scans, architecture, jobs, schedules, artifacts, decisions, digests, council, knowledge, transfer):
