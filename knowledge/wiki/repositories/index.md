...
| [[impeccable]] | partial-borrow | Apache-2.0, local after install. Additive execution/anti-AI-slop layer beneath Design Intelligence: 46 deterministic anti-pattern rules + 5-dim audit rubric. Candidates (not greenlit): vendor rules into AOS design-system skill (Option B), or install as Claude Code plugin (Option A) | Design Intelligence, Control Tower (apps/web) | evaluated | [[../../../docs/repo-research/impeccable\|report]] |
