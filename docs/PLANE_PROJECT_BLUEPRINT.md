...
| AOS-72 | Evaluate: impeccable (Done) | `knowledge/wiki/repositories/impeccable.md` | `038b67b1-84c5-4531-8103-4d7360edb09d` |
| AOS-73 | Vendor impeccable design rules into AOS design-system skill | `knowledge/wiki/repositories/impeccable.md` | `4f75a8e0-ec4c-4a71-bb32-144e0f135143` |
| AOS-74 | Install impeccable as a Claude Code plugin (design work) | `knowledge/wiki/repositories/impeccable.md` | `a31ffa17-3c4b-4077-9692-65bfd687ff82` |
| AOS-75 | Design-lint for apps/web from impeccable rules (RFC-first) | `knowledge/wiki/repositories/impeccable.md` | `9954900f-78ab-4118-85ab-5b61269e02fb` |
