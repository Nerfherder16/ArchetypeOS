...
from .routes import architecture, artifacts, council, decisions, digests, jobs, knowledge, projects, repositories, scans, schedules, transfer, usage, voice
...
for _module in (projects, repositories, scans, architecture, jobs, schedules, artifacts, decisions, digests, council, knowledge, transfer, usage, voice):
