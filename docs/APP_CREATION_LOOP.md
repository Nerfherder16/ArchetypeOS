...
Idea -> Intake -> Research -> Architecture -> Technology Fitness -> Plan -> Work Packages -> Branch Isolation -> Build -> Verification -> PR Monitoring -> Merge -> Knowledge Update -> Roadmap Update
...
- PR Guardian passes
- state files are updated or explicitly not affected
- handoff is durable

After merge:

- lessons are captured
- knowledge artifacts are updated when applicable
