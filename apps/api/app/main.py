...
from .routes import architecture, artifacts, authority, connectors, council, decisions, digests, jobs, knowledge, nodes, projects, repositories, research, scans, schedules, transfer, usage, voice
...
for _module in (projects, repositories, scans, architecture, jobs, schedules, artifacts, decisions, digests, council, research, knowledge, transfer, usage, voice, nodes, connectors, authority):
